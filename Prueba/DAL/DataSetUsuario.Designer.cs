...
namespace DAL {
    ...
    public partial class DataSetUsuario : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsuarioRow AddUsuarioRow(string Nombre_usuario, string password, bool Activo) {
...
namespace DAL.DataSetUsuarioTableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Usuario] WHERE (([CodigoUsuario] = @Original_CodigoUsuario) AND ((@IsNull_Nombre_usuario = 1 AND [Nombre_usuario] IS NULL) OR ([Nombre_usuario] = @Original_Nombre_usuario)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_Activo = 1 AND [Activo] IS NULL) OR ([Activo] = @Original_Activo)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Usuario] ([Nombre_usuario], [password], [Activo]) VALUES (@Nombre_us" +
                "uario, @password, @Activo);\r\nSELECT CodigoUsuario, Nombre_usuario, password, Act" +
                "ivo FROM Usuario WHERE (CodigoUsuario = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Usuario] SET [Nombre_usuario] = @Nombre_usuario, [password] = @password, [Activo] = @Activo WHERE (([CodigoUsuario] = @Original_CodigoUsuario) AND ((@IsNull_Nombre_usuario = 1 AND [Nombre_usuario] IS NULL) OR ([Nombre_usuario] = @Original_Nombre_usuario)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_Activo = 1 AND [Activo] IS NULL) OR ([Activo] = @Original_Activo)));
SELECT CodigoUsuario, Nombre_usuario, password, Activo FROM Usuario WHERE (CodigoUsuario = @CodigoUsuario)";
        ...
        public virtual int Delete(int Original_CodigoUsuario, string Original_Nombre_usuario, string Original_password, global::System.Nullable<bool> Original_Activo) {
        ...
        public virtual int Insert(string Nombre_usuario, string password, global::System.Nullable<bool> Activo) {
        ...
        public virtual int Update(string Nombre_usuario, string password, global::System.Nullable<bool> Activo, int Original_CodigoUsuario, string Original_Nombre_usuario, string Original_password, global::System.Nullable<bool> Original_Activo, int CodigoUsuario) {
            if ((Nombre_usuario == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_CodigoUsuario));
            if ((Original_Nombre_usuario == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(CodigoUsuario));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre_usuario, string password, global::System.Nullable<bool> Activo, int Original_CodigoUsuario, string Original_Nombre_usuario, string Original_password, global::System.Nullable<bool> Original_Activo) {
            return this.Update(Nombre_usuario, password, Activo, Original_CodigoUsuario, Original_Nombre_usuario, Original_password, Original_Activo, Original_CodigoUsuario);
        }
    }
